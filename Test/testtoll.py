...
def gettolllist(token):
    url = BASE + 'etoll/gettolls/'
...
if __name__ == "__main__":
    ...
    # print(gettolllist(login_token1))
    # tok1 = loads(login1())['token']
    # rc = "DL02J0123"
    # print(gettolltax(tok1, rc))
    # print(paymentsuccess(tok1, rc))
    print(qrverify1("DL123456789012,DL02J0123,DL02J"))
